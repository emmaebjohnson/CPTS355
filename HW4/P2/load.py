...
tests = [testinput1,testinput2,testinput3,testinput4,testinput5,testinput6,testinput7,testinput8,testinput9,testinput10,
         ...
         testinput22,testinput23,testinput24,testinput25,testinput26,testinput27,testinput28,testinput29,testinput30,testinput31,testinput32,test_input33]
...
opstack = {
    ...
    'test33': [StringValue('(World)'), StringValue('(Hello)'), StringValue('(ell)')]}
...
parse output = {
    ...
    'test33': [ PSString(Hello), PSString(World), PSName(add), PSName(dup), Literal(0), PSName(get), Literal(2), Literal(101), PSName(put), PSName(dup), Literal(1), Literal(3), PSName(getinterval)]}
"""
